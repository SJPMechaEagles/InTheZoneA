 ...
 * @date 9/27/2017
 * @brief Declarations and macros for determining the location of the robot.
 *[WIP]
 **/
 ...
 * @prama The multiplier parameter can tune the gyro to adapt to specific
 *sensors. The default value at this time is 196; higher values will increase
 *the number of degrees reported for a fixed actual rotation, while lower values
 *will decrease the number of degrees reported. If your robot is consistently
 *turning too far, increase the multiplier, and if it is not turning far enough,
