...
\begin{DoxyCompactList}\small\item\em Reference type for an initialized gyro. \end{DoxyCompactList}\item 
typedef void($\ast$ \textbf{ Interrupt\+Handler}) (unsigned char pin)
\begin{DoxyCompactList}\small\item\em Type definition for interrupt handlers. \end{DoxyCompactList}\item 
typedef void $\ast$ \textbf{ Mutex}
\begin{DoxyCompactList}\small\item\em Type by which mutexes are referenced. \end{DoxyCompactList}\item 
typedef int \textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE}
\begin{DoxyCompactList}\small\item\em P\+R\+O\+S\+\_\+\+F\+I\+LE is an integer referring to a stream for the standard I/O functions. \end{DoxyCompactList}\item 
typedef void $\ast$ \textbf{ Semaphore}
\begin{DoxyCompactList}\small\item\em Type by which semaphores are referenced. \end{DoxyCompactList}\item 
typedef void($\ast$ \textbf{ Task\+Code}) (void $\ast$)
\begin{DoxyCompactList}\small\item\em Type for defining task functions. \end{DoxyCompactList}\item 
typedef void $\ast$ \textbf{ Task\+Handle}
\begin{DoxyCompactList}\small\item\em Type by which tasks are referenced. \end{DoxyCompactList}\item 
typedef void $\ast$ \textbf{ Ultrasonic}
\begin{DoxyCompactList}\small\item\em Reference type for an initialized ultrasonic sensor. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
void \textbf{ \+\_\+\+\_\+attribute\+\_\+\+\_\+} ((format(\textbf{ printf}, 3, 4))) \textbf{ lcd\+Print}(\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$lcd\+Port
\item 
int \textbf{ analog\+Calibrate} (unsigned char channel)
\begin{DoxyCompactList}\small\item\em Calibrates the analog sensor on the specified channel. \end{DoxyCompactList}\item 
int \textbf{ analog\+Read} (unsigned char channel)
\begin{DoxyCompactList}\small\item\em Reads an analog input channel and returns the 12-\/bit value. \end{DoxyCompactList}\item 
int \textbf{ analog\+Read\+Calibrated} (unsigned char channel)
\begin{DoxyCompactList}\small\item\em Reads the calibrated value of an analog input channel. \end{DoxyCompactList}\item 
int \textbf{ analog\+Read\+Calibrated\+HR} (unsigned char channel)
\begin{DoxyCompactList}\small\item\em Reads the calibrated value of an analog input channel 1-\/8 with enhanced precision. \end{DoxyCompactList}\item 
void \textbf{ delay} (const unsigned long time)
\begin{DoxyCompactList}\small\item\em Wiring-\/compatible alias of \doxyref{task\+Delay()}{p.}{_a_p_i_8h_ac89618d0782547d189fe412a9917639b}. \end{DoxyCompactList}\item 
void \textbf{ delay\+Microseconds} (const unsigned long us)
\begin{DoxyCompactList}\small\item\em Wait for approximately the given number of microseconds. \end{DoxyCompactList}\item 
bool \textbf{ digital\+Read} (unsigned char pin)
\begin{DoxyCompactList}\small\item\em Gets the digital value (1 or 0) of a pin configured as a digital input. \end{DoxyCompactList}\item 
void \textbf{ digital\+Write} (unsigned char pin, bool value)
\begin{DoxyCompactList}\small\item\em Sets the digital value (1 or 0) of a pin configured as a digital output. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Initializes and enables a quadrature encoder on two digital ports. \end{DoxyCompactList}\item 
void \textbf{ encoder\+Reset} (\textbf{ Encoder} enc)
\begin{DoxyCompactList}\small\item\em Resets the encoder to zero. \end{DoxyCompactList}\item 
void \textbf{ encoder\+Shutdown} (\textbf{ Encoder} enc)
\begin{DoxyCompactList}\small\item\em Stops and disables the encoder. \end{DoxyCompactList}\item 
void \textbf{ fclose} (\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$stream)
\begin{DoxyCompactList}\small\item\em Closes the specified file descriptor. \end{DoxyCompactList}\item 
int \textbf{ fcount} (\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$stream)
\begin{DoxyCompactList}\small\item\em Returns the number of characters that can be read without blocking (the number of characters available) from the specified stream. \end{DoxyCompactList}\item 
int \textbf{ fdelete} (const char $\ast$file)
\begin{DoxyCompactList}\small\item\em Delete the specified file if it exists and is not currently open. \end{DoxyCompactList}\item 
int \textbf{ feof} (\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$stream)
\begin{DoxyCompactList}\small\item\em Checks to see if the specified stream is at its end. \end{DoxyCompactList}\item 
int \textbf{ fflush} (\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$stream)
\begin{DoxyCompactList}\small\item\em Flushes the data on the specified file channel open in Write mode. \end{DoxyCompactList}\item 
int \textbf{ fgetc} (\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$stream)
\begin{DoxyCompactList}\small\item\em Reads and returns one character from the specified stream, blocking until complete. \end{DoxyCompactList}\item 
char $\ast$ \textbf{ fgets} (char $\ast$str, int num, \textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$stream)
\begin{DoxyCompactList}\small\item\em Reads a string from the specified stream, storing the characters into the memory at str. \end{DoxyCompactList}\item 
\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$ \textbf{ fopen} (const char $\ast$file, const char $\ast$mode)
\begin{DoxyCompactList}\small\item\em Opens the given file in the specified mode. \end{DoxyCompactList}\item 
void \textbf{ fprint} (const char $\ast$string, \textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$stream)
\begin{DoxyCompactList}\small\item\em Prints the simple string to the specified stream. \end{DoxyCompactList}\item 
int \textbf{ fprintf} (\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$stream, const char $\ast$\textbf{ format\+String},...)
\begin{DoxyCompactList}\small\item\em Prints the formatted string to the specified output stream. \end{DoxyCompactList}\item 
int \textbf{ fputc} (int value, \textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$stream)
\begin{DoxyCompactList}\small\item\em Writes one character to the specified stream. \end{DoxyCompactList}\item 
int \textbf{ fputs} (const char $\ast$string, \textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$stream)
\begin{DoxyCompactList}\small\item\em Behaves the same as the \char`\"{}fprint\char`\"{} function, and appends a trailing newline (\char`\"{}\textbackslash{}n\char`\"{}). \end{DoxyCompactList}\item 
size\+\_\+t \textbf{ fread} (void $\ast$ptr, size\+\_\+t size, size\+\_\+t count, \textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$stream)
\begin{DoxyCompactList}\small\item\em Reads data from a stream into memory. \end{DoxyCompactList}\item 
int \textbf{ fseek} (\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$stream, long int offset, int origin)
\begin{DoxyCompactList}\small\item\em Seeks within a file open in Read mode. \end{DoxyCompactList}\item 
long int \textbf{ ftell} (\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$stream)
\begin{DoxyCompactList}\small\item\em Returns the current position of the stream. \end{DoxyCompactList}\item 
size\+\_\+t \textbf{ fwrite} (const void $\ast$ptr, size\+\_\+t size, size\+\_\+t count, \textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$stream)
\begin{DoxyCompactList}\small\item\em Writes data from memory to a stream. \end{DoxyCompactList}\item 
int \textbf{ getchar} ()
\begin{DoxyCompactList}\small\item\em Reads and returns one character from \char`\"{}stdin\char`\"{}, which is the PC debug terminal. \end{DoxyCompactList}\item 
int \textbf{ gyro\+Get} (\textbf{ Gyro} gyro)
\begin{DoxyCompactList}\small\item\em Gets the current gyro angle in degrees, rounded to the nearest degree. \end{DoxyCompactList}\item 
\textbf{ Gyro} \textbf{ gyro\+Init} (unsigned char port, unsigned short multiplier)
\begin{DoxyCompactList}\small\item\em Initializes and enables a gyro on an analog port. \end{DoxyCompactList}\item 
void \textbf{ gyro\+Reset} (\textbf{ Gyro} gyro)
\begin{DoxyCompactList}\small\item\em Resets the gyro to zero. \end{DoxyCompactList}\item 
void \textbf{ gyro\+Shutdown} (\textbf{ Gyro} gyro)
\begin{DoxyCompactList}\small\item\em Stops and disables the gyro. \end{DoxyCompactList}\item 
bool \textbf{ i2c\+Read} (uint8\+\_\+t addr, uint8\+\_\+t $\ast$data, uint16\+\_\+t count)
\begin{DoxyCompactList}\small\item\em i2c\+Read -\/ Reads the specified number of data bytes from the specified 7-\/bit I2C address. \end{DoxyCompactList}\item 
bool \textbf{ i2c\+Read\+Register} (uint8\+\_\+t addr, uint8\+\_\+t reg, uint8\+\_\+t $\ast$value, uint16\+\_\+t count)
\begin{DoxyCompactList}\small\item\em i2c\+Read\+Register -\/ Reads the specified amount of data from the given register address on the specified 7-\/bit I2C address. \end{DoxyCompactList}\item 
bool \textbf{ i2c\+Write} (uint8\+\_\+t addr, uint8\+\_\+t $\ast$data, uint16\+\_\+t count)
\begin{DoxyCompactList}\small\item\em i2c\+Write -\/ Writes the specified number of data bytes to the specified 7-\/bit I2C address. \end{DoxyCompactList}\item 
bool \textbf{ i2c\+Write\+Register} (uint8\+\_\+t addr, uint8\+\_\+t reg, uint16\+\_\+t value)
\begin{DoxyCompactList}\small\item\em i2c\+Write\+Register -\/ Writes the specified data byte to a register address on the specified 7-\/bit I2C address. \end{DoxyCompactList}\item 
bool \textbf{ ime\+Get} (unsigned char address, int $\ast$value)
\begin{DoxyCompactList}\small\item\em Gets the current 32-\/bit count of the specified I\+ME. \end{DoxyCompactList}\item 
bool \textbf{ ime\+Get\+Velocity} (unsigned char address, int $\ast$value)
\begin{DoxyCompactList}\small\item\em Gets the current rotational velocity of the specified I\+ME. \end{DoxyCompactList}\item 
unsigned int \textbf{ ime\+Initialize\+All} ()
\begin{DoxyCompactList}\small\item\em Initializes all I\+M\+Es. \end{DoxyCompactList}\item 
bool \textbf{ ime\+Reset} (unsigned char address)
\begin{DoxyCompactList}\small\item\em Resets the specified I\+ME\textquotesingle{}s counters to zero. \end{DoxyCompactList}\item 
void \textbf{ ime\+Shutdown} ()
\begin{DoxyCompactList}\small\item\em Shuts down all I\+M\+Es on the chain; their addresses return to the default and the stored counts and velocities are lost. \end{DoxyCompactList}\item 
void \textbf{ io\+Clear\+Interrupt} (unsigned char pin)
\begin{DoxyCompactList}\small\item\em Disables interrupts on the specified pin. \end{DoxyCompactList}\item 
void \textbf{ io\+Set\+Interrupt} (unsigned char pin, unsigned char edges, \textbf{ Interrupt\+Handler} handler)
\begin{DoxyCompactList}\small\item\em Sets up an interrupt to occur on the specified pin, and resets any counters or timers associated with the pin. \end{DoxyCompactList}\item 
bool \textbf{ is\+Autonomous} ()
\begin{DoxyCompactList}\small\item\em Returns true if the robot is in autonomous mode, or false otherwise. \end{DoxyCompactList}\item 
bool \textbf{ is\+Enabled} ()
\begin{DoxyCompactList}\small\item\em Returns true if the robot is enabled, or false otherwise. \end{DoxyCompactList}\item 
bool \textbf{ is\+Joystick\+Connected} (unsigned char \textbf{ joystick})
\begin{DoxyCompactList}\small\item\em Returns true if a joystick is connected to the specified slot number (1 or 2), or false otherwise. \end{DoxyCompactList}\item 
bool \textbf{ is\+Online} ()
\begin{DoxyCompactList}\small\item\em Returns true if a V\+EX field controller or competition switch is connected, or false otherwise. \end{DoxyCompactList}\item 
int \textbf{ joystick\+Get\+Analog} (unsigned char \textbf{ joystick}, unsigned char axis)
\begin{DoxyCompactList}\small\item\em Gets the value of a control axis on the V\+EX joystick. \end{DoxyCompactList}\item 
bool \textbf{ joystick\+Get\+Digital} (unsigned char \textbf{ joystick}, unsigned char button\+Group, unsigned char button)
\begin{DoxyCompactList}\small\item\em Gets the value of a button on the V\+EX joystick. \end{DoxyCompactList}\item 
void \textbf{ lcd\+Clear} (\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$lcd\+Port)
\begin{DoxyCompactList}\small\item\em Clears the L\+CD screen on the specified port. \end{DoxyCompactList}\item 
void \textbf{ lcd\+Init} (\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$lcd\+Port)
\begin{DoxyCompactList}\small\item\em Initializes the L\+CD port, but does not change the text or settings. \end{DoxyCompactList}\item 
void \textbf{ lcd\+Print} (\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$lcd\+Port, unsigned char \textbf{ line}, const char $\ast$\textbf{ format\+String},...)
\begin{DoxyCompactList}\small\item\em Prints the formatted string to the attached L\+CD. \end{DoxyCompactList}\item 
void unsigned char const char unsigned int \textbf{ lcd\+Read\+Buttons} (\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$lcd\+Port)
\begin{DoxyCompactList}\small\item\em Reads the user button status from the L\+CD display. \end{DoxyCompactList}\item 
void \textbf{ lcd\+Set\+Backlight} (\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$lcd\+Port, bool backlight)
\begin{DoxyCompactList}\small\item\em Sets the specified L\+CD backlight to be on or off. \end{DoxyCompactList}\item 
void \textbf{ lcd\+Set\+Text} (\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$lcd\+Port, unsigned char \textbf{ line}, const char $\ast$buffer)
\begin{DoxyCompactList}\small\item\em Prints the string buffer to the attached L\+CD. \end{DoxyCompactList}\item 
void \textbf{ lcd\+Shutdown} (\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$lcd\+Port)
\begin{DoxyCompactList}\small\item\em Shut down the specified L\+CD port. \end{DoxyCompactList}\item 
unsigned long \textbf{ micros} ()
\begin{DoxyCompactList}\small\item\em Returns the number of microseconds since Cortex power-\/up. \end{DoxyCompactList}\item 
unsigned long \textbf{ millis} ()
\begin{DoxyCompactList}\small\item\em Returns the number of milliseconds since Cortex power-\/up. \end{DoxyCompactList}\item 
int \textbf{ motor\+Get} (unsigned char channel)
\begin{DoxyCompactList}\small\item\em Gets the last set speed of the specified motor channel. \end{DoxyCompactList}\item 
void \textbf{ motor\+Set} (unsigned char channel, int speed)
\begin{DoxyCompactList}\small\item\em Sets the speed of the specified motor channel. \end{DoxyCompactList}\item 
void \textbf{ motor\+Stop} (unsigned char channel)
\begin{DoxyCompactList}\small\item\em Stops the motor on the specified channel, equivalent to calling \doxyref{motor\+Set()}{p.}{_a_p_i_8h_a03c5b04b472d024281f62d7af8854a8e} with an argument of zero. \end{DoxyCompactList}\item 
void \textbf{ motor\+Stop\+All} ()
\begin{DoxyCompactList}\small\item\em Stops all motors; significantly faster than looping through all motor ports and calling motor\+Set(channel, 0) on each one. \end{DoxyCompactList}\item 
\textbf{ Mutex} \textbf{ mutex\+Create} ()
\begin{DoxyCompactList}\small\item\em Creates a mutex intended to allow only one task to use a resource at a time. \end{DoxyCompactList}\item 
void \textbf{ mutex\+Delete} (\textbf{ Mutex} mutex)
\begin{DoxyCompactList}\small\item\em Deletes the specified mutex. \end{DoxyCompactList}\item 
bool \textbf{ mutex\+Give} (\textbf{ Mutex} mutex)
\begin{DoxyCompactList}\small\item\em Relinquishes a mutex so that other tasks can use the resource it guards. \end{DoxyCompactList}\item 
bool \textbf{ mutex\+Take} (\textbf{ Mutex} mutex, const unsigned long block\+Time)
\begin{DoxyCompactList}\small\item\em Requests a mutex so that other tasks cannot simultaneously use the resource it guards. \end{DoxyCompactList}\item 
void \textbf{ pin\+Mode} (unsigned char pin, unsigned char mode)
\begin{DoxyCompactList}\small\item\em Configures the pin as an input or output with a variety of settings. \end{DoxyCompactList}\item 
unsigned int \textbf{ power\+Level\+Backup} ()
\begin{DoxyCompactList}\small\item\em Returns the backup battery voltage in millivolts. \end{DoxyCompactList}\item 
unsigned int \textbf{ power\+Level\+Main} ()
\begin{DoxyCompactList}\small\item\em Returns the main battery voltage in millivolts. \end{DoxyCompactList}\item 
void \textbf{ print} (const char $\ast$string)
\begin{DoxyCompactList}\small\item\em Prints the simple string to the debug terminal without formatting. \end{DoxyCompactList}\item 
int \textbf{ printf} (const char $\ast$\textbf{ format\+String},...)
\begin{DoxyCompactList}\small\item\em Prints the formatted string to the debug stream (the PC terminal). \end{DoxyCompactList}\item 
int \textbf{ putchar} (int value)
\begin{DoxyCompactList}\small\item\em Writes one character to \char`\"{}stdout\char`\"{}, which is the PC debug terminal, and returns the input value. \end{DoxyCompactList}\item 
int \textbf{ puts} (const char $\ast$string)
\begin{DoxyCompactList}\small\item\em Behaves the same as the \char`\"{}print\char`\"{} function, and appends a trailing newline (\char`\"{}\textbackslash{}n\char`\"{}). \end{DoxyCompactList}\item 
\textbf{ Semaphore} \textbf{ semaphore\+Create} ()
\begin{DoxyCompactList}\small\item\em Creates a semaphore intended for synchronizing tasks. \end{DoxyCompactList}\item 
void \textbf{ semaphore\+Delete} (\textbf{ Semaphore} semaphore)
\begin{DoxyCompactList}\small\item\em Deletes the specified semaphore. \end{DoxyCompactList}\item 
bool \textbf{ semaphore\+Give} (\textbf{ Semaphore} semaphore)
\begin{DoxyCompactList}\small\item\em Signals a semaphore. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Sets the team name displayed to the V\+EX field control and V\+EX Firmware Upgrade. \end{DoxyCompactList}\item 
int \textbf{ snprintf} (char $\ast$buffer, size\+\_\+t limit, const char $\ast$\textbf{ format\+String},...)
\begin{DoxyCompactList}\small\item\em Prints the formatted string to the string buffer with the specified length limit. \end{DoxyCompactList}\item 
void \textbf{ speaker\+Init} ()
\begin{DoxyCompactList}\small\item\em Initializes V\+EX speaker support. \end{DoxyCompactList}\item 
void \textbf{ speaker\+Play\+Array} (const char $\ast$$\ast$songs)
\begin{DoxyCompactList}\small\item\em Plays up to three R\+T\+T\+TL (Ring Tone Text Transfer Language) songs simultaneously over the V\+EX speaker. \end{DoxyCompactList}\item 
void \textbf{ speaker\+Play\+Rtttl} (const char $\ast$song)
\begin{DoxyCompactList}\small\item\em Plays an R\+T\+T\+TL (Ring Tone Text Transfer Language) song over the V\+EX speaker. \end{DoxyCompactList}\item 
void \textbf{ speaker\+Shutdown} ()
\begin{DoxyCompactList}\small\item\em Powers down and disables the V\+EX speaker. \end{DoxyCompactList}\item 
int \textbf{ sprintf} (char $\ast$buffer, const char $\ast$\textbf{ format\+String},...)
\begin{DoxyCompactList}\small\item\em Prints the formatted string to the string buffer. \end{DoxyCompactList}\item 
void \textbf{ standalone\+Mode\+Enable} ()
\begin{DoxyCompactList}\small\item\em Enables the Cortex to run the op control task in a standalone mode-\/ no V\+E\+Xnet connection required. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Delays the current task for a given number of milliseconds. \end{DoxyCompactList}\item 
void \textbf{ task\+Delay\+Until} (unsigned long $\ast$previous\+Wake\+Time, const unsigned long cycle\+Time)
\begin{DoxyCompactList}\small\item\em Delays the current task until a specified time. \end{DoxyCompactList}\item 
void \textbf{ task\+Delete} (\textbf{ Task\+Handle} task\+To\+Delete)
\begin{DoxyCompactList}\small\item\em Kills and removes the specified task from the kernel task list. \end{DoxyCompactList}\item 
unsigned int \textbf{ task\+Get\+Count} ()
\begin{DoxyCompactList}\small\item\em Determines the number of tasks that are currently being managed. \end{DoxyCompactList}\item 
unsigned int \textbf{ task\+Get\+State} (\textbf{ Task\+Handle} task)
\begin{DoxyCompactList}\small\item\em Retrieves the state of the specified task. \end{DoxyCompactList}\item 
unsigned int \textbf{ task\+Priority\+Get} (const \textbf{ Task\+Handle} task)
\begin{DoxyCompactList}\small\item\em Obtains the priority of the specified task. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Resumes the specified task. \end{DoxyCompactList}\item 
\textbf{ Task\+Handle} \textbf{ task\+Run\+Loop} (void($\ast$fn)(void), const unsigned long increment)
\begin{DoxyCompactList}\small\item\em Starts a task which will periodically call the specified function. \end{DoxyCompactList}\item 
void \textbf{ task\+Suspend} (\textbf{ Task\+Handle} task\+To\+Suspend)
\begin{DoxyCompactList}\small\item\em Suspends the specified task. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Initializes an ultrasonic sensor on the specified digital ports. \end{DoxyCompactList}\item 
void \textbf{ ultrasonic\+Shutdown} (\textbf{ Ultrasonic} ult)
\begin{DoxyCompactList}\small\item\em Stops and disables the ultrasonic sensor. \end{DoxyCompactList}\item 
void \textbf{ usart\+Init} (\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$usart, unsigned int baud, unsigned int flags)
\begin{DoxyCompactList}\small\item\em Initialize the specified serial interface with the given connection parameters. \end{DoxyCompactList}\item 
void \textbf{ usart\+Shutdown} (\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$usart)
\begin{DoxyCompactList}\small\item\em Disables the specified U\+S\+A\+RT interface. \end{DoxyCompactList}\item 
void \textbf{ wait} (const unsigned long time)
\begin{DoxyCompactList}\small\item\em Alias of \doxyref{task\+Delay()}{p.}{_a_p_i_8h_ac89618d0782547d189fe412a9917639b} intended to help EasyC users. \end{DoxyCompactList}\item 
void \textbf{ wait\+Until} (unsigned long $\ast$previous\+Wake\+Time, const unsigned long time)
\begin{DoxyCompactList}\small\item\em Alias of \doxyref{task\+Delay\+Until()}{p.}{_a_p_i_8h_ae93bc867b1aa4a12d6536a497f1b6869} intended to help EasyC users. \end{DoxyCompactList}\item 
void \textbf{ watchdog\+Init} ()
\begin{DoxyCompactList}\small\item\em Enables I\+W\+DG watchdog timer which will reset the cortex if it locks up due to static shock or a misbehaving task preventing the timer to be reset. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Task functions must accept one parameter of type \char`\"{}void $\ast$\char`\"{}; they need not use it.
...
Referenced by \textbf{ auton\+\_\+raise\+\_\+sec\+\_\+lifter\+\_\+max()}, \textbf{ auton\+\_\+rasie\+\_\+main\+\_\+lifter()}, \textbf{ autostack\+\_\+routine()}, \textbf{ deploy\+\_\+seoncdary\+\_\+lifter()}, \textbf{ get\+Lifter\+Ticks()}, \textbf{ main\+\_\+lifter\+\_\+update()}, \textbf{ secondary\+\_\+lifter\+\_\+update()}, and \textbf{ update\+\_\+lifter()}.
...
Referenced by \textbf{ calculate\+\_\+accelerometer\+\_\+odemetry()}, and \textbf{ get\+\_\+main\+\_\+gyro\+\_\+angluar\+\_\+velocity()}.
...
Referenced by \textbf{ autonomous()}, \textbf{ autostack\+\_\+routine()}, \textbf{ display\+\_\+menu()}, \textbf{ operator\+Control()}, \textbf{ promt\+\_\+confirmation()}, and \textbf{ start\+\_\+auton()}.
...
This function does not work on communication ports; use \doxyref{usart\+Shutdown()}{p.}{_a_p_i_8h_a802efaab0ca93c799eb82d42cf009e07} instead.
...
The file name is truncated to eight characters. Only four files can be in use simultaneously in any given time, with at most one of those files in Write mode. This function does not work on communication ports; use \doxyref{usart\+Init()}{p.}{_a_p_i_8h_a86066f3cf35f5fca7ec405189773182c} instead.
...
Invalid format specifiers, or mismatched parameters to specifiers, cause undefined behavior. Other characters are written out verbatim. Do not use \doxyref{fprintf()}{p.}{_a_p_i_8h_ab9989f4619e4d3ccb13ed4c36d5f787a} on a V\+EX L\+CD port. Use \doxyref{lcd\+Print()}{p.}{_a_p_i_8h_a6cfad8271c6a566a2f51ca318f819a80} instead.
...
Referenced by \textbf{ init\+\_\+localization()}, and \textbf{ init\+\_\+main\+\_\+gyro()}.
...
i2c\+Read -\/ Reads the specified number of data bytes from the specified 7-\/bit I2C address. 
...
i2c\+Read\+Register -\/ Reads the specified amount of data from the given register address on the specified 7-\/bit I2C address. 
...
i2c\+Write -\/ Writes the specified number of data bytes to the specified 7-\/bit I2C address. 
...
i2c\+Write\+Register -\/ Writes the specified data byte to a register address on the specified 7-\/bit I2C address. 
...
Referenced by \textbf{ auton\+\_\+drive\+\_\+towards\+\_\+mobile\+\_\+goal()}, \textbf{ autonomous()}, \textbf{ get\+\_\+encoder\+\_\+ticks()}, and \textbf{ setup\+\_\+ime\+\_\+auton()}.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_a_p_i_8h_ac4f1500418a729ac3ee95bce9768b20c_icgraph}
\end{center}
\end{figure}
...
Referenced by \textbf{ setup\+\_\+ime\+\_\+auton()}.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_a_p_i_8h_ab1ef9ee5f8878856896a6c920ed762fc_icgraph}
\end{center}
\end{figure}
...
Shuts down all I\+M\+Es on the chain; their addresses return to the default and the stored counts and velocities are lost. 

This function, unlike the other I\+ME functions, is not thread safe.
...
Gets the value of a control axis on the V\+EX joystick. 
...
Gets the value of a button on the V\+EX joystick. 
...
Referenced by \textbf{ button\+Get\+State()}, \textbf{ main\+\_\+lifter\+\_\+update()}, \textbf{ secondary\+\_\+lifter\+\_\+update()}, \textbf{ update\+\_\+claw()}, and \textbf{ update\+\_\+intake()}.
...
Referenced by \textbf{ init\+\_\+error()}, \textbf{ lcd\+\_\+clear()}, and \textbf{ log\+\_\+info()}.
...
\begin{center}
\leavevmode
\includegraphics[width=320pt]{_a_p_i_8h_a43dc11a67b697c0d32315ea5a9af85f9_icgraph}
\end{center}
\end{figure}
\mbox{\label{_a_p_i_8h_a6cfad8271c6a566a2f51ca318f819a80}} 
\index{A\+P\+I.\+h@{A\+P\+I.\+h}!lcd\+Print@{lcd\+Print}}
\index{lcd\+Print@{lcd\+Print}!A\+P\+I.\+h@{A\+P\+I.\+h}}
\paragraph{lcd\+Print()}
{\footnotesize\ttfamily void lcd\+Print (\begin{DoxyParamCaption}\item[{\textbf{ P\+R\+O\+S\+\_\+\+F\+I\+LE} $\ast$}]{lcd\+Port,  }\item[{unsigned char}]{line,  }\item[{const char $\ast$}]{format\+String,  }\item[{}]{... }\end{DoxyParamCaption})}
...
Referenced by \textbf{ lcd\+\_\+printf()}, and \textbf{ log\+\_\+info()}.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_a_p_i_8h_a6cfad8271c6a566a2f51ca318f819a80_icgraph}
\end{center}
\end{figure}
...
The output string will be truncated as necessary to fit on the L\+CD screen, 16 characters wide. This function, like \doxyref{fprint()}{p.}{_a_p_i_8h_a874987bcf339f25df0bdbc24f27a03db}, is much, much faster than a formatted routine such as \doxyref{lcd\+Print()}{p.}{_a_p_i_8h_a6cfad8271c6a566a2f51ca318f819a80} and consumes less memory.
...
There are 10$^\wedge$6 microseconds in a second, so as a 32-\/bit integer, this will overflow and wrap back to zero every two hours or so.
...
The mutex must be held by the current task using a corresponding call to mutex\+Take.
...
Referenced by \textbf{ autostack\+\_\+routine()}, \textbf{ calculate\+\_\+accelerometer\+\_\+odemetry()}, \textbf{ calculate\+\_\+current\+\_\+display()}, \textbf{ calculate\+\_\+encoder\+\_\+odemetry()}, \textbf{ debug()}, \textbf{ display\+\_\+menu()}, \textbf{ init\+\_\+encoders()}, \textbf{ init\+\_\+error()}, \textbf{ init\+\_\+menu\+\_\+var()}, \textbf{ lcd\+\_\+assert()}, \textbf{ log\+\_\+info()}, \textbf{ print\+Matrix()}, and \textbf{ update\+\_\+lifter()}.
...
Tasks waiting for a signal using \doxyref{semaphore\+Take()}{p.}{_a_p_i_8h_a7520baa9cf5c9ec2f43925b098e7b46a} will be unblocked by this call and can continue execution.
...
If the semaphore is already in the \char`\"{}taken\char`\"{} state, the current task will wait for the semaphore to be signaled. Other tasks can run during this time.
...
Plays up to three R\+T\+T\+TL (Ring Tone Text Transfer Language) songs simultaneously over the V\+EX speaker. 

The audio is mixed to allow polyphonic sound to be played. Many simple songs are available in R\+T\+T\+TL format online, or compose your own.
...
Plays an R\+T\+T\+TL (Ring Tone Text Transfer Language) song over the V\+EX speaker. 

Many simple songs are available in R\+T\+T\+TL format online, or compose your own.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_a_p_i_8h_abd5e503a273aaf6abf6869ebd76f2d2d_icgraph}
\end{center}
\end{figure}
...
The task will be unblocked at the time $\ast$previous\+Wake\+Time + cycle\+Time, and $\ast$previous\+Wake\+Time will be changed to reflect the time at which the task will unblock.
...
Referenced by \textbf{ init\+\_\+localization()}, \textbf{ init\+\_\+routine()}, and \textbf{ init\+\_\+slew()}.
...
Referenced by \textbf{ autostack\+\_\+routine()}, and \textbf{ main\+\_\+lifter\+\_\+update()}.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_a_p_i_8h_a435d7fc1c3c3da80ed64cf9dfed0bd42_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=240pt]{_a_p_i_8h_aed267558847e901e3741bd031c4fc83d_icgraph}
\end{center}
\end{figure}
...
Enables I\+W\+DG watchdog timer which will reset the cortex if it locks up due to static shock or a misbehaving task preventing the timer to be reset. 
