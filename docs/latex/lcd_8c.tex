...
\begin{DoxyCompactItemize}
\item 
static \textbf{ F\+I\+LE} $\ast$ \textbf{ lcd\+\_\+port} = N\+U\+LL
...
References \textbf{ lcd\+\_\+port}, and \textbf{ printf()}.
...
{\footnotesize\ttfamily \textbf{ F\+I\+LE}$\ast$ lcd\+\_\+port = N\+U\+LL\hspace{0.3cm}{\ttfamily [static]}}
